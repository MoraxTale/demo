...
public class GameState implements Serializable {
     ...
     */
    public GameState(int qi, double qiRate, Map<String, AlchemyController.PillData> pills, Map<String, TreasureData> treasures,
                     int stageLevel,long lastSaveTime,AdventureState adventureState) {
        this.qi = qi;
        this.qiRate = qiRate;
        this.pills = pills;
